...
class NotificationTypeService {
    ...
    public create = async (model: CreateDto) => {
        ...
        const result = await database.executeQuery(`insert into ${this.tableName} (name, publish, created_id, created_at, updated_at) values (?, ?, ?, ?, ?)`, [model.name, publish, model.created_id, created_at, updated_at]);
