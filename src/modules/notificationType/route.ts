...
class NotificationTypeRoute implements IRoute {
    public path = '/notification-type';
    public router = Router();

    public controller = new NotificationTypeController();
...
export default NotificationTypeRoute;