...
import { PurchaseOrderDetailController } from "./controller";
import { AuthMiddleware, errorMiddleware } from "@core/middleware";
import { CreateDto } from "./dtos/create.dto";

class PurchaseOrderDetailRoute implements IRoute {
    public path = '/warehouse-details';
    public router = Router();

    public controller = new PurchaseOrderDetailController();
...
export default PurchaseOrderDetailRoute;