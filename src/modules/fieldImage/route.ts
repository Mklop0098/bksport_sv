...
import { FieldImageController } from "./controller";
import { AuthMiddleware, errorMiddleware } from "@core/middleware";
import { CreateDto } from "./dtos/Create.dto";
import multer from "multer";
import uploadFileMiddleware from "@core/middleware/uploadFile.middleware";

class FieldImageRoute implements IRoute {
    public path = '/product-image';
    public router = Router();

    public controller = new FieldImageController();
...
export default FieldImageRoute;