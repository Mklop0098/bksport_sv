...
export class UserAddressController {
    public service = new UserAddressService();
    ...
    public searchs = async (req: Request, res: Response, next: NextFunction) => {
        ...
        try {
            const result = await this.service.searchs(key, name, publish, pageInt, limitInt, seller_id);
            if (result instanceof Error)
                return sendResponse(res, result.status, result.message);
    ...
    public findAddressesByCustomerId = async (req: Request, res: Response, next: NextFunction) => {
        try {
            const customer_id: number = req.params.customer_id as any;
            const result = await this.service.findAddressesByCustomerId(customer_id);
            if (result instanceof Error)
                return sendResponse(res, result.status, result.message);
            return sendResponse(res, 200, message.FIND_ALL_SUCCESS, result);
        } catch (error) {
    ...
    public updateDefaultAddress = async (req: Request, res: Response, next: NextFunction) => {
        const id: number = req.params.id as any;
        try {
            const result = await this.service.updateDefaultAddress(id);
            if (result instanceof Error)
                return sendResponse(res, result.status, result.message);
            return sendResponse(res, 200, message.UPDATE_SUCCESS);
        } catch (error) {
    ...
    public findDefaultAddressByCustomerId = async (req: Request, res: Response, next: NextFunction) => {
        try {
            const customer_id: number = req.params.customer_id as any;
            const result = await this.service.findDefaultAddressByCustomerId(customer_id);
            if (result instanceof Error)
                return sendResponse(res, result.status, result.message);
            return sendResponse(res, 200, message.FIND_ALL_SUCCESS, result);
        } catch (error) {
