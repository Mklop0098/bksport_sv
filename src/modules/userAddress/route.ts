...
class UserAddressRoute implements IRoute {
    public path = '/user-address';
    public router = Router();

    public controller = new UserAddressController();
    ...
    private initializeRoutes() {
        ...
        this.router.put(this.path + '/update-is-default/:id', AuthMiddleware.authorization(true), this.controller.updateDefaultAddress);
        this.router.get(this.path + '/findAddressByCustomerId/:customer_id', AuthMiddleware.authorization(true), this.controller.findAddressesByCustomerId);
        this.router.get(this.path + '/findDefaultAddressByCustomerId/:customer_id', AuthMiddleware.authorization(true), this.controller.findDefaultAddressByCustomerId);
    }
}
